...
export default function About () {
    return (
        <>
            ...
            <div className="col-8">
              <h1 className="mt-4">LANGLOIS Noah</h1>
              <p className="mt-3">Actuellement étudiant ingénieur à l&apos;<a href="https://www.ensma.fr/" 
              ...
              <p>Vous pourrez retrouver sur ce site toutes les informations me concerant, mon expérience, ma formation et plein
                d&apos;autres ! N&apos;hésitez pas à me contacter !
              </p>
            </div>
            <div className="col ms-5">
              <Image src={Id} alt="" height='250'></Image>
            </div>
          </div>
          <div className="mt-5">
            <p>
